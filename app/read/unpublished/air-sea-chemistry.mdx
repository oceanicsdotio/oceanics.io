...
published: "2011-12-17T12:00:00.000Z"
description: |
...
labels: ["surface microlayer", "chemistry", "biogeochemisty", "carbon"]
references: []
---
...
<Equation text={"-d \\gamma = \\sum_{1}^{n}(\\Gamma_i d \\mu_i)"}/>
...
<Equation text={"W_{TEP} = (C_t - C_0) \\cdot {{V}\\over{\\pi} } \\cdot r_c^2 \\cdot C_0 \\cdot t"}/>
...
<Equation text={"\\alpha = 6.38 \\cdot 10^{-4} \\cdot {{TEP} \\over {CHL}} - 0.0033"}/>
