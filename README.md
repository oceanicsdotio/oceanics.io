...
Testing will also populate the connected databases with the information described in `config/bathysphere.yml`. The default things are semi-fictitious and won't suit your needs. Use them as examples to make your own. Most importantly, find an entry like this and make a copy, replacing it with your own information:
