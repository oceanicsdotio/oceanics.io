...
description: |
    Great job getting that capital expenses grant! Now you have idle physical assets. Here is a pattern we like for demonstrating your largesse by automatically allocating things (buoys) to agents (sea farms). 
tags: ["crowdsourcing", "campaign", "unbias", "automated negotiation"]
citations:
  - authors: [Dunn JC]
    year: 1973
    title: |
