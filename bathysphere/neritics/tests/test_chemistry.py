from neritics.chemistry.organic import Carbon, Oxygen, Sulphur
from neritics.chemistry.nutrient import Nitrogen, Phosphorus, Silica, NITROGEN, NOX, AMMONIUM
...
class TestOrganicChemistry(TestCase):
...
class TestNutrientChemistry(TestCase):
